...
public class PerfectShuffle extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mTabManager.addTab(mTabHost.newTabSpec("albums").setIndicator("Albums"), Playlist.class, null);
    mTabManager.addTab(mTabHost.newTabSpec("all").setIndicator("All Music"), Playlist.class, null);
    // mTabManager.addTab(mTabHost.newTabSpec("artists").setIndicator("Artists"), Playlist.class, null);
